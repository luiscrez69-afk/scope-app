 ...
 * Dynamic Issues List Container (Issue 01: Rural Municipal Engineer Availability & Compliance Gap)
 */

export function createHomeCards() {
  return `
    <section class="centered-dual-cards-section" id="centered-dual-cards" style="padding: 3.5rem 0 4.5rem; background: var(--bg-main); border-bottom: 1px solid var(--border-color);">
      <div class="scope-container">
        ...
        <div class="current-issues-container" style="max-width: 920px; margin: 0 auto; display: flex; flex-direction: column; gap: 1.8rem;">
