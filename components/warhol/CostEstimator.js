        ...
        <div class="estimator-wizard-box" style="background: var(--bg-card); border: var(--border-thick); box-shadow: 8px 8px 0px var(--cmyk-cyan); padding: 2.5rem; position: relative;">
          ...
          <div class="wizard-carousel-viewport" style="overflow: hidden; min-height: 560px; position: relative;">
            <div class="wizard-carousel-track" style="display: flex; transition: transform 0.45s cubic-bezier(0.16, 1, 0.3, 1); width: 500%;">
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div class="land-plot-graphic-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-yellow); padding: 1.2rem; position: relative;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
                    <span style="color: var(--cmyk-yellow); font-weight: 900;">📐 INTERACTIVE LAND BOUNDARY & BUILDABLE FOOTPRINT MATRIX</span>
                  ...
                  <div style="width: 100%; height: 320px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="plot-svg-canvas" viewBox="0 0 500 280" style="width: 100%; height: 100%;">
                      <defs>
                        <pattern id="hatch-pattern" width="12" height="12" patternTransform="rotate(45 0 0)" patternUnits="userSpaceOnUse">
                          <line x1="0" y1="0" x2="0" y2="12" stroke="#FF007F" stroke-width="2.5" />
                        </pattern>
                      </defs>
                      ...
                      <rect id="svg-plot-rect" x="60" y="25" width="380" height="230" fill="none" stroke="#FFD700" stroke-width="3.5" />
                      <rect id="svg-setback-rect" x="80" y="40" width="340" height="200" fill="none" stroke="#00E5FF" stroke-width="2.5" stroke-dasharray="6,4" />
                      <rect id="svg-build-rect" x="95" y="52" width="310" height="176" fill="url(#hatch-pattern)" fill-opacity="0.35" stroke="#FF007F" stroke-width="3" />
                      <text id="svg-plot-dim-w" x="250" y="18" fill="#FFD700" font-family="monospace" font-size="12" font-weight="bold" text-anchor="middle">37.0 FT (WIDTH)</text>
                      <text id="svg-plot-dim-h" x="455" y="140" fill="#FFD700" font-family="monospace" font-size="12" font-weight="bold" text-anchor="start">37.0 FT (DEPTH)</text>
                      ...
                      <text id="svg-plot-sqft-txt" x="250" y="155" fill="#00E5FF" font-family="monospace" font-size="11" font-weight="bold" text-anchor="middle">958 SQ. FT. GROUND COVERAGE</text>
                    </svg>
                  </div>
              ...
              <!-- STEP 2: STOREYS SELECTOR & EXPANDED ARCHITECTURAL ELEVATION GRAPHIC -->
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <!-- EXPANDED DYNAMIC NEOBRUTALIST ARCHITECTURAL ELEVATION GRAPHIC SVG -->
                <div class="elevation-graphic-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-pink); padding: 1.2rem; position: relative;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
                    <span style="color: var(--cmyk-pink); font-weight: 900;">🏛️ STRUCTURAL ELEVATION CROSS-SECTION MATRIX</span>
                  ...
                  <div style="width: 100%; height: 320px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="elevation-svg-canvas" viewBox="0 0 500 300" style="width: 100%; height: 100%;">
                      ...
                      <text x="320" y="285" fill="#FFD700" font-family="monospace" font-size="10" font-weight="bold">PLINTH LEVEL +2'0"</text>
                      ...
                      <text id="elev-height-txt" x="38" y="180" fill="#00E5FF" font-family="monospace" font-size="11" font-weight="bold" text-anchor="middle" transform="rotate(-90 38 180)">28.5 FT TOTAL HEIGHT</text>

                      <g id="floor-l1" opacity="1">
                        <rect x="75" y="200" width="240" height="65" fill="none" stroke="#FFD700" stroke-width="2.5" />
                        <line x1="75" y1="200" x2="315" y2="200" stroke="#FFF" stroke-width="3.5" />
                        <rect x="85" y="200" width="16" height="65" fill="#FFD700" />
                        <rect x="185" y="200" width="16" height="65" fill="#FFD700" />
                        <rect x="290" y="200" width="16" height="65" fill="#FFD700" />
                        <rect x="115" y="215" width="50" height="35" fill="none" stroke="#00E5FF" stroke-width="2" />
                        <text x="330" y="235" fill="#FFD700" font-family="monospace" font-size="11" font-weight="bold">L01: GROUND PLINTH (10.0 FT)</text>
                      </g>

                      <g id="floor-l2" opacity="1">
                        <rect x="75" y="135" width="240" height="65" fill="none" stroke="#00E5FF" stroke-width="2.5" />
                        <line x1="75" y1="135" x2="315" y2="135" stroke="#FFF" stroke-width="3.5" />
                        <rect x="85" y="135" width="16" height="65" fill="#00E5FF" />
                        <rect x="185" y="135" width="16" height="65" fill="#00E5FF" />
                        <rect x="290" y="135" width="16" height="65" fill="#00E5FF" />
                        <rect x="115" y="150" width="50" height="35" fill="none" stroke="#FFD700" stroke-width="2" />
                        <rect x="225" y="150" width="50" height="35" fill="none" stroke="#FFD700" stroke-width="2" />
                        <text x="330" y="170" fill="#00E5FF" font-family="monospace" font-size="11" font-weight="bold">L02: UPPER FLOOR (10.0 FT)</text>
                      </g>

                      <g id="floor-l2-5" opacity="1">
                        <rect x="75" y="90" width="130" height="45" fill="none" stroke="#FF007F" stroke-width="2.5" />
                        <line x1="75" y1="90" x2="205" y2="90" stroke="#FFF" stroke-width="3" />
                        <line x1="205" y1="120" x2="315" y2="120" stroke="#FF007F" stroke-width="2.5" stroke-dasharray="4,4" />
                        <rect x="85" y="90" width="14" height="45" fill="#FF007F" />
                        <rect x="180" y="90" width="14" height="45" fill="#FF007F" />
                        <text x="330" y="115" fill="#FF007F" font-family="monospace" font-size="11" font-weight="bold">L0.5: TERRACE CABIN (8.5 FT)</text>
                      </g>

                      <g id="floor-l3" opacity="0">
                        <rect x="75" y="70" width="240" height="65" fill="none" stroke="#00FF66" stroke-width="2.5" />
                        <line x1="75" y1="70" x2="315" y2="70" stroke="#FFF" stroke-width="3.5" />
                        <rect x="85" y="70" width="16" height="65" fill="#00FF66" />
                        <rect x="185" y="70" width="16" height="65" fill="#00FF66" />
                        <rect x="290" y="70" width="16" height="65" fill="#00FF66" />
                        <text x="330" y="105" fill="#00FF66" font-family="monospace" font-size="11" font-weight="bold">L03: TOP LEVEL FLOOR (10.0 FT)</text>
                      </g>
                    </svg>
                  </div>
              ...
              <!-- STEP 3: FINISH QUALITY TIERS WITH EXPANDED PURE VECTOR SVG MATERIAL ASSEMBLY GRAPHIC -->
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div style="display: flex; flex-direction: column; gap: 1.2rem; margin-bottom: 1.5rem;">
                  <button class="tier-btn btn-brutal white" data-tier="basic" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center; background: #000; color: #FFF; border: 2px solid #FFF;">
                    <div>
                  ...
                  <button class="tier-btn btn-brutal yellow active" data-tier="standard" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center; background: var(--cmyk-yellow); color: #000; border: 2px solid #FFF;">
                    <div>
                  ...
                  <button class="tier-btn btn-brutal pink" data-tier="premium" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center; background: #000; color: #FFF; border: 2px solid #FFF;">
                    <div>
                ...
                <!-- EXPANDED DYNAMIC PURE VECTOR SVG MATERIAL ASSEMBLY GRAPHIC CONTAINER -->
                <div id="material-spec-container" class="material-spec-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-yellow); padding: 1.2rem; position: relative;">
                  ...
                  <div style="width: 100%; height: 320px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="mat-assembly-svg" viewBox="0 0 550 280" style="width: 100%; height: 100%;">
                      <defs>
                        <pattern id="pat-std-tile" width="32" height="32" patternUnits="userSpaceOnUse">
                          <path d="M 32 0 L 0 0 0 32" fill="none" stroke="#FFD700" stroke-width="1.5" />
                        </pattern>
                      </defs>
                      ...
                      <g id="cutaway-group">
                        ...
                        <rect id="cutaway-floor-layer" x="20" y="190" width="250" height="20" fill="url(#pat-std-tile)" stroke="#FFD700" stroke-width="2" />
                        <rect x="215" y="25" width="55" height="165" fill="#111" stroke="#FFF" stroke-width="2.5" />
                        <rect id="cutaway-wall-layer" x="270" y="25" width="16" height="165" fill="#FFD700" opacity="0.85" />
                        <rect id="cutaway-window-frame" x="120" y="65" width="65" height="85" fill="none" stroke="#00E5FF" stroke-width="2.5" />
                      </g>
                      ...
                      <g id="swatch-matrix-group">
                        <g id="swatch-tile-1" transform="translate(325, 25)">
                          ...
                          <rect id="swatch-bg-1" x="6" y="6" width="93" height="68" fill="url(#pat-std-tile)" />
                          <text id="swatch-lbl-1" x="52" y="93" fill="#FFD700" font-family="monospace" font-size="8.5" font-weight="bold" text-anchor="middle">VITRIFIED // 600x600</text>
                        </g>

                        <g id="swatch-tile-2" transform="translate(438, 25)">
                          <rect x="0" y="0" width="105" height="105" fill="#000" stroke="#FFF" stroke-width="2" />
                          <text id="swatch-lbl-2" x="52" y="93" fill="#FF007F" font-family="monospace" font-size="8.5" font-weight="bold" text-anchor="middle">UPVC // ALUMINUM</text>
                        </g>

                        <g id="swatch-tile-3" transform="translate(325, 145)">
                          <rect x="0" y="0" width="105" height="105" fill="#000" stroke="#FFF" stroke-width="2" />
                          <text id="swatch-lbl-3" x="52" y="93" fill="#00E5FF" font-family="monospace" font-size="8.5" font-weight="bold" text-anchor="middle">CONCEALED // CP</text>
                        </g>

                        <g id="swatch-tile-4" transform="translate(438, 145)">
                          <rect x="0" y="0" width="105" height="105" fill="#000" stroke="#FFF" stroke-width="2" />
                          <text id="swatch-lbl-4" x="52" y="93" fill="#00FF66" font-family="monospace" font-size="8.5" font-weight="bold" text-anchor="middle">APEX // ACRYLIC</text>
                        </g>
                      </g>
                    </svg>
                  </div>
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <!-- EXPANDED DYNAMIC NEOBRUTALIST MUNICIPAL PERMIT GRAPHIC BOARD -->
                <div id="permit-stamp-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px #00FF66; padding: 1.2rem; position: relative;">
                  ...
                  <div style="width: 100%; height: 300px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="permit-stamp-svg" viewBox="0 0 520 260" style="width: 100%; height: 100%;">
                      <g transform="translate(20, 30)">
                        <rect x="0" y="0" width="230" height="200" fill="#0A0A0F" stroke="#00E5FF" stroke-width="2" />
                        <text x="15" y="30" fill="#00E5FF" font-family="monospace" font-size="11" font-weight="bold">KMC MUNICIPAL BLUEPRINT</text>
                        <rect x="20" y="48" width="190" height="130" fill="none" stroke="#FFF" stroke-width="1.5" stroke-dasharray="4,4" />
                        <circle cx="115" cy="113" r="40" fill="none" stroke="#FFD700" stroke-width="2" />
                        <text x="115" y="108" fill="#FFD700" font-family="monospace" font-size="9" font-weight="bold" text-anchor="middle">OFFICIAL SEAL</text>
                        <text x="115" y="123" fill="#00FF66" font-family="monospace" font-size="9" font-weight="bold" text-anchor="middle">APPROVED</text>
                      </g>
                      <g transform="translate(270, 30)">
                        <rect x="0" y="0" width="230" height="200" fill="#0A0A0F" stroke="#FFD700" stroke-width="2" />
                        <text x="15" y="30" fill="#FFD700" font-family="monospace" font-size="11" font-weight="bold">SOIL BEARING TEST REPORT</text>
                        <rect x="20" y="48" width="190" height="130" fill="none" stroke="#FFF" stroke-width="1.5" stroke-dasharray="4,4" />
                        <circle cx="115" cy="113" r="40" fill="none" stroke="#00FF66" stroke-width="2" />
                        <text x="115" y="108" fill="#00FF66" font-family="monospace" font-size="9" font-weight="bold" text-anchor="middle">GEOTECH OK</text>
