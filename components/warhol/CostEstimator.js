 ...
 * Dynamic Neobrutalist Architectural Land Plot Graphic SVG, Structural Elevation Graphic SVG,
    ...
    <div id="estimate" class="tab-pane active-pane">
      <div class="scope-container">
        ...
        <div class="section-title-wrap" style="margin-bottom: 2rem;">
          <div>
            <span class="section-tag" style="background: var(--cmyk-yellow); color: #000; font-weight: 900;">KATHMANDU VALLEY // 5-STEP GUIDED WIZARD</span>
        ...
        <div class="estimator-wizard-box" style="background: var(--bg-card); border: var(--border-thick); box-shadow: 8px 8px 0px var(--cmyk-cyan); padding: 2.5rem; position: relative;">
          ...
          <div style="margin-bottom: 2rem;">
            <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.85rem; font-weight: 700; margin-bottom: 0.8rem;">
              <span id="wizard-step-badge" style="color: var(--cmyk-yellow);">STEP 01 OF 05 // LAND AREA</span>
            ...
            <div class="wizard-carousel-track" style="display: flex; transition: transform 0.45s cubic-bezier(0.16, 1, 0.3, 1); width: 500%;">
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div class="control-group" style="background: #000; border: 2px solid #FFF; padding: 1.8rem; margin-bottom: 1.5rem;">
                  <div class="control-label" style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                    <span style="color: var(--cmyk-cyan); font-weight: 700; font-size: 1.1rem;">PLOT SIZE:</span>
                    <span id="ktm-aana-val" style="color: #FFF; font-weight: 900; font-size: 1.4rem; font-family: var(--font-mono);">4.0 AANA (1,369 SQ. FT.)</span>
                  </div>
                  <input type="range" id="ktm-aana-slider" class="brutal-slider" min="2" max="10" step="0.5" value="4" style="width: 100%; height: 16px; cursor: pointer; accent-color: var(--cmyk-yellow);" />
                ...
                <div class="land-plot-graphic-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-yellow); padding: 1.2rem; position: relative;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <span style="background: var(--cmyk-pink); color: #FFF; font-weight: 900; padding: 0.15rem 0.5rem; border: 1px solid #FFF; font-size: 0.65rem;">VISUAL SCALE // 1 AANA = 342.25 SQ FT</span>
                  </div>
                  ...
                  <div style="display: flex; justify-content: space-between; font-family: var(--font-mono); font-size: 0.75rem; color: #AAA; margin-top: 0.8rem; border-top: 1px dashed #333; padding-top: 0.6rem; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <div>MAX GROUND COVERAGE (70%): <span id="plot-spec-built" style="color: var(--cmyk-pink); font-weight: 700;">958.3 SQ. FT.</span></div>
                  </div>
                </div>
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1.2rem; margin-bottom: 1.5rem;">
                  <button class="storey-btn btn-brutal white" data-storey="1" style="padding: 1.5rem 1rem; flex-direction: column; gap: 0.5rem; align-items: center; text-align: center;">
                    ...
                    <span style="font-size: 0.75rem; color: #555;">Single Floor Bungalow</span>
                  </button>
                  <button class="storey-btn btn-brutal cyan" data-storey="2" style="padding: 1.5rem 1rem; flex-direction: column; gap: 0.5rem; align-items: center; text-align: center;">
                    ...
                    <span style="font-size: 0.75rem; color: #000;">Double Storey Residence</span>
                  </button>
                  <button class="storey-btn btn-brutal yellow active" data-storey="2.5" style="padding: 1.5rem 1rem; flex-direction: column; gap: 0.5rem; align-items: center; text-align: center;">
                    ...
                    <span style="font-size: 0.75rem; color: #000;">Standard KTM Residence</span>
                  </button>
                  <button class="storey-btn btn-brutal pink" data-storey="3" style="padding: 1.5rem 1rem; flex-direction: column; gap: 0.5rem; align-items: center; text-align: center;">
                    ...
                    <span style="font-size: 0.75rem; color: #FFF;">Full 3-Storey Villa</span>
                  </button>
                </div>
                  ...
                  <div style="width: 100%; height: 210px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="elevation-svg-canvas" viewBox="0 0 400 210" style="width: 100%; height: 100%;">
                      ...
                      <g id="floor-l2" opacity="1">
                        ...
                        <text x="245" y="120" fill="#00E5FF" font-family="monospace" font-size="10" font-weight="bold">L02: UPPER RESIDENCE (10.0 FT)</text>
                      </g>
                      ...
                      <g id="floor-l3" opacity="0">
                        ...
                        <text x="245" y="65" fill="#00FF66" font-family="monospace" font-size="10" font-weight="bold">L03: TOP VILLA FLOOR (10.0 FT)</text>
                      </g>
                    </svg>
                  </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.2rem; margin-bottom: 1.5rem;">
                  <button class="tier-btn btn-brutal white" data-tier="basic" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 1.2rem;">
                      <div style="width: 76px; height: 54px; border: 2px solid #FFF; box-shadow: 3px 3px 0px var(--cmyk-pink); overflow: hidden; flex-shrink: 0; position: relative;">
                      ...
                      <div>
                        ...
                        <div style="font-size: 0.8rem; color: #666; margin-top: 0.2rem;">Local brick, standard porcelain tiles, PVC & local fittings</div>
                      </div>
                    </div>
                    <span style="font-family: var(--font-mono); font-size: 1rem; font-weight: 900; color: var(--cmyk-orange); white-space: nowrap;">NPR 3,800 / SQ. FT.</span>
                  </button>
                  ...
                  <button class="tier-btn btn-brutal yellow active" data-tier="standard" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 1.2rem;">
                      <div style="width: 76px; height: 54px; border: 2px solid #000; box-shadow: 3px 3px 0px #000; overflow: hidden; flex-shrink: 0; position: relative;">
                        <img src="${FINISH_TIERS.standard.img}" alt="Standard Kathmandu Finish" style="width: 100%; height: 100%; object-fit: cover;">
                        <span style="position: absolute; bottom: 0; left: 0; right: 0; background: var(--cmyk-yellow); color: #000; font-family: var(--font-mono); font-size: 0.55rem; text-align: center; font-weight: 900; padding: 1px 0;">RECOMMENDED</span>
                      </div>
                      <div>
                        <div style="font-weight: 900; font-size: 1.05rem;">🏢 STANDARD TIER (RECOMMENDED)</div>
                        <div style="font-size: 0.8rem; color: #000; margin-top: 0.2rem;">AAC/Red brick, quality tiles, CP fittings, aluminum doors & windows</div>
                      </div>
                    </div>
                    <span style="font-family: var(--font-mono); font-size: 1rem; font-weight: 900; color: #000; white-space: nowrap;">NPR 4,800 / SQ. FT.</span>
                  </button>
                  ...
                  <button class="tier-btn btn-brutal pink" data-tier="premium" style="justify-content: space-between; width: 100%; text-align: left; padding: 1.2rem 1.4rem; gap: 1rem; align-items: center;">
                    <div style="display: flex; align-items: center; gap: 1.2rem;">
                      <div style="width: 76px; height: 54px; border: 2px solid #FFF; box-shadow: 3px 3px 0px var(--cmyk-cyan); overflow: hidden; flex-shrink: 0; position: relative;">
                        <img src="${FINISH_TIERS.premium.img}" alt="Premium Luxury Finish" style="width: 100%; height: 100%; object-fit: cover;">
                        <span style="position: absolute; bottom: 0; left: 0; right: 0; background: var(--cmyk-pink); color: #FFF; font-family: var(--font-mono); font-size: 0.55rem; text-align: center; font-weight: 900; padding: 1px 0;">LUXURY</span>
                      </div>
                      <div>
                        <div style="font-weight: 900; font-size: 1.05rem;">✨ PREMIUM LUXURY TIER</div>
                        <div style="font-size: 0.8rem; color: #FFF; margin-top: 0.2rem;">Italian marble, Kohler sanitary, teak wood doors, structural steel retrofitting</div>
                      </div>
                    </div>
                    <span style="font-family: var(--font-mono); font-size: 1rem; font-weight: 900; color: #FFF; white-space: nowrap;">NPR 6,800 / SQ. FT.</span>
                  </button>
                </div>

                <!-- DYNAMIC PURE VECTOR SVG MATERIAL ASSEMBLY CUTAWAY & SWATCH GRAPHIC CONTAINER -->
                <div id="material-spec-container" class="material-spec-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-yellow); padding: 1.2rem; position: relative; transition: box-shadow 0.3s ease;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <span style="background: var(--cmyk-pink); color: #FFF; font-weight: 900; padding: 0.15rem 0.5rem; border: 1px solid #FFF; font-size: 0.65rem;">VECTOR ASSEMBLY // ZERO TEXT MATRIX</span>
                  </div>
                  ...
                  <div style="width: 100%; height: 230px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="mat-assembly-svg" viewBox="0 0 500 230" style="width: 100%; height: 100%;">
                      <defs>
                        <pattern id="pat-basic-tile" width="16" height="16" patternUnits="userSpaceOnUse">
                        ...
                        <pattern id="pat-hpl-cladding" width="12" height="20" patternUnits="userSpaceOnUse">
                          <rect width="12" height="20" fill="none" stroke="#FF007F" stroke-width="1" />
                          <line x1="0" y1="10" x2="12" y2="10" stroke="#FF007F" stroke-width="1" />
                        </pattern>
                      </defs>
                      ...
                      <g id="cutaway-group">
                        ...
                        <rect id="cutaway-floor-layer" x="20" y="140" width="200" height="15" fill="url(#pat-std-tile)" stroke="#FFD700" stroke-width="1.5" />
                        <rect x="170" y="25" width="50" height="115" fill="#111" stroke="#FFF" stroke-width="2" />
                        <rect id="cutaway-wall-layer" x="215" y="25" width="12" height="115" fill="#FFD700" opacity="0.8" />
                        <rect id="cutaway-window-frame" x="125" y="50" width="45" height="60" fill="none" stroke="#00E5FF" stroke-width="2" />
                        <line id="cutaway-glass-1" x1="140" y1="50" x2="140" y2="110" stroke="#00E5FF" stroke-width="2" />
                        <line id="cutaway-glass-2" x1="155" y1="50" x2="155" y2="110" stroke="#00E5FF" stroke-width="1.5" stroke-dasharray="2,2" />
                        <path d="M 70 130 L 100 130 L 110 145" fill="none" stroke="#00E5FF" stroke-width="1.5" />
                        <text id="lbl-callout-floor" x="30" y="126" fill="#00E5FF" font-family="monospace" font-size="9" font-weight="bold">---> FLOOR FINISH</text>
                        <path d="M 100 75 L 125 75" fill="none" stroke="#FF007F" stroke-width="1.5" />
                        <text id="lbl-callout-win" x="35" y="78" fill="#FF007F" font-family="monospace" font-size="9" font-weight="bold">---> PROFILE</text>
                      </g>
                      ...
                      <g id="swatch-matrix-group">
                        <g id="swatch-tile-1" transform="translate(260, 20)">
                          ...
                          <rect id="swatch-bg-1" x="5" y="5" width="90" height="60" fill="url(#pat-std-tile)" />
                          <rect x="0" y="65" width="100" height="25" fill="#18181A" stroke="#FFF" stroke-width="1" />
                          <text id="swatch-lbl-1" x="50" y="81" fill="#FFD700" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">VITRIFIED // 600x600</text>
                          <text x="5" y="15" fill="#00E5FF" font-family="monospace" font-size="8" font-weight="bold">[01] FLOOR</text>
                        </g>

                        <g id="swatch-tile-2" transform="translate(375, 20)">
                          <rect x="0" y="0" width="100" height="90" fill="#000" stroke="#FFF" stroke-width="1.5" />
                          <g id="swatch-joinery-graphic" stroke="#FF007F" stroke-width="1.5" fill="none">
                            <rect x="15" y="12" width="70" height="46" />
                            <line x1="50" y1="12" x2="50" y2="58" />
                            <circle cx="43" cy="35" r="2" fill="#FF007F" />
                          </g>
                          <rect x="0" y="65" width="100" height="25" fill="#18181A" stroke="#FFF" stroke-width="1" />
                          <text id="swatch-lbl-2" x="50" y="81" fill="#FF007F" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">UPVC // SAL WOOD</text>
                          <text x="5" y="15" fill="#FF007F" font-family="monospace" font-size="8" font-weight="bold">[02] JOINERY</text>
                        </g>

                        <g id="swatch-tile-3" transform="translate(260, 120)">
                          <rect x="0" y="0" width="100" height="90" fill="#000" stroke="#FFF" stroke-width="1.5" />
                          <g id="swatch-sanitary-graphic" stroke="#00E5FF" stroke-width="1.5" fill="none">
                            <path d="M 25 20 C 25 45, 75 45, 75 20 Z" />
                            <rect x="35" y="15" width="30" height="8" />
                            <circle cx="50" cy="32" r="3" fill="#00E5FF" />
                          </g>
                          <rect x="0" y="65" width="100" height="25" fill="#18181A" stroke="#FFF" stroke-width="1" />
                          <text id="swatch-lbl-3" x="50" y="81" fill="#00E5FF" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">CONCEALED // CP</text>
                          <text x="5" y="15" fill="#FFD700" font-family="monospace" font-size="8" font-weight="bold">[03] SANITARY</text>
                        </g>

                        <g id="swatch-tile-4" transform="translate(375, 120)">
                          <rect x="0" y="0" width="100" height="90" fill="#000" stroke="#FFF" stroke-width="1.5" />
                          <rect id="swatch-bg-4" x="5" y="5" width="90" height="60" fill="none" stroke="#00FF66" stroke-width="1" stroke-dasharray="3,3" />
                          <rect x="0" y="65" width="100" height="25" fill="#18181A" stroke="#FFF" stroke-width="1" />
                          <text id="swatch-lbl-4" x="50" y="81" fill="#00FF66" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">APEX // ACRYLIC</text>
                          <text x="5" y="15" fill="#00FF66" font-family="monospace" font-size="8" font-weight="bold">[04] FACADE</text>
                        </g>
                      </g>
                    </svg>
                  </div>
                  ...
                  <div style="display: flex; justify-content: space-between; font-family: var(--font-mono); font-size: 0.75rem; color: #AAA; margin-top: 0.8rem; border-top: 1px dashed #333; padding-top: 0.6rem; flex-wrap: wrap; gap: 0.5rem;">
                    <div>ASSEMBLY TIER: <span id="mat-spec-grade" style="color: var(--cmyk-yellow); font-weight: 700;">STANDARD A-GRADE RESIDENTIAL</span></div>
                    <div>VECTOR CUTAWAY: <span style="color: var(--cmyk-cyan); font-weight: 700;">LIVE STRUCTURAL JUNCTION</span></div>
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div id="permit-stamp-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px #00FF66; padding: 1.2rem; position: relative;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
                    <span style="color: #00FF66; font-weight: 900;">📜 DIGITAL PERMIT BLUEPRINT & APPROVAL SEAL BOARD</span>
                    <span style="background: #00FF66; color: #000; font-weight: 900; padding: 0.15rem 0.5rem; border: 1px solid #FFF; font-size: 0.65rem;">MUNICIPAL CLEARANCE MATRIX // KATHMANDU METRO REGULATION</span>
                  </div>

                  <div style="width: 100%; height: 230px; position: relative; background: #000; border: 1px dashed #333; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                    <svg id="permit-stamp-svg" viewBox="0 0 500 230" style="width: 100%; height: 100%;">
                      <defs>
                        <pattern id="excluded-hatch" width="10" height="10" patternTransform="rotate(45 0 0)" patternUnits="userSpaceOnUse">
                          <line x1="0" y1="0" x2="0" y2="10" stroke="#444" stroke-width="1.5" />
                        </pattern>
                        <pattern id="soil-bedrock-pattern" width="12" height="12" patternUnits="userSpaceOnUse">
                      ...
                      <g id="state-excluded" opacity="0">
                        <rect x="20" y="20" width="460" height="190" fill="url(#excluded-hatch)" fill-opacity="0.3" stroke="#444" stroke-width="1.5" stroke-dasharray="4,4" />
                      ...
                      <g id="state-included" opacity="1">
                        ...
                        <g id="group-naksha-stamp" opacity="1">
                          <rect x="20" y="20" width="220" height="190" fill="#0A0A0F" stroke="#00E5FF" stroke-width="1.5" />
                          <text x="30" y="38" fill="#00E5FF" font-family="monospace" font-size="9" font-weight="bold">[CAD BLUEPRINT TRACE]</text>

                          <g stroke="#00E5FF" stroke-width="1" fill="none" opacity="0.6">
                          ...
                          <g transform="translate(30, 130)">
                            ...
                            <rect id="led-stage-1" x="0" y="8" width="55" height="16" fill="#00FF66" stroke="#FFF" stroke-width="1" />
                            <text x="27" y="19" fill="#000" font-family="monospace" font-size="7" font-weight="bold" text-anchor="middle">WARD</text>

                            <rect id="led-stage-2" x="60" y="8" width="55" height="16" fill="#00FF66" stroke="#FFF" stroke-width="1" />
                            <text x="87" y="19" fill="#000" font-family="monospace" font-size="7" font-weight="bold" text-anchor="middle">REGISTRATION</text>

                            <rect id="led-stage-3" x="120" y="8" width="55" height="16" fill="#00FF66" stroke="#FFF" stroke-width="1" />
                            <text x="147" y="19" fill="#000" font-family="monospace" font-size="7" font-weight="bold" text-anchor="middle">IJAJAT</text>
                          </g>
                          ...
                          <g transform="translate(30, 172)">
                            ...
                            <rect x="0" y="6" width="40" height="10" fill="#FFD700" />
                            <rect x="40" y="6" width="100" height="10" fill="#00E5FF" />
                            <rect x="140" y="6" width="60" height="10" fill="#FF007F" />
                          </g>

                          <g transform="translate(45, 65) rotate(-8)">
                            <rect x="0" y="0" width="170" height="32" fill="none" stroke="#00FF66" stroke-width="2.5" rx="3" />
                            <text x="85" y="14" fill="#00FF66" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">KMC MUNICIPAL PERMIT</text>
                            <text x="85" y="24" fill="#00FF66" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">APPROVED // NPR 60,000</text>
                          </g>
                        </g>

                        <!-- RIGHT BOARD: Geotechnical Soil Core Sample -->
                        <g id="group-soil-stamp" opacity="1">
                          <rect x="260" y="20" width="220" height="190" fill="#0A0A0F" stroke="#FFD700" stroke-width="1.5" />
                          <text x="270" y="38" fill="#FFD700" font-family="monospace" font-size="9" font-weight="bold">[GEOTECHNICAL SOIL CORE]</text>
                          ...
                          <g transform="translate(270, 48)">
                            ...
                            <text x="5" y="35" fill="#FFD700" font-family="monospace" font-size="8">CLAY / SILT 2.5M</text>

                            <rect x="0" y="45" width="100" height="30" fill="url(#soil-bedrock-pattern)" stroke="#444" stroke-width="1" />
                            <text x="5" y="62" fill="#00E5FF" font-family="monospace" font-size="8">HARD STRATA 4.0M</text>

                            <rect x="115" y="10" width="80" height="65" fill="none" stroke="#FFF" stroke-width="1.5" />
                            <path d="M 135 10 L 135 50 L 120 65 L 190 65 L 175 50 L 175 10 Z" fill="#FF007F" fill-opacity="0.3" stroke="#FF007F" stroke-width="1.5" />
                          ...
                          <g transform="translate(275, 140)">
                            <rect x="0" y="0" width="190" height="32" fill="none" stroke="#FFD700" stroke-width="2" rx="3" />
                            <text x="95" y="14" fill="#FFD700" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">SOIL BEARING CAPACITY</text>
                            <text x="95" y="24" fill="#FFD700" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">VERIFIED // NPR 45,000</text>
                          </g>
                  ...
                  <div style="display: flex; justify-content: space-between; font-family: var(--font-mono); font-size: 0.75rem; color: #AAA; margin-top: 0.8rem; border-top: 1px dashed #333; padding-top: 0.6rem; flex-wrap: wrap; gap: 0.5rem;">
                    <div>ADD-ONS STATUS: <span id="permit-spec-status" style="color: #00FF66; font-weight: 700;">BOTH PERMITS INCLUDED (+NPR 105,000)</span></div>
                    <div>VALIDATION: <span style="color: var(--cmyk-cyan); font-weight: 700;">NEC REGISTERED STAMP</span></div>
                    <div>LEGAL CODE: <span style="color: var(--cmyk-pink); font-weight: 700;">NBC 105:2020</span></div>
                  </div>
                </div>
              ...
              <div class="wizard-slide" style="width: 20%; padding: 1.5rem; box-sizing: border-box; flex-shrink: 0;">
                ...
                <div id="cost-summary-card" class="receipt-card" style="background: #000; border: 3px solid var(--cmyk-yellow); padding: 1.8rem; box-shadow: 6px 6px 0px var(--cmyk-yellow); margin-bottom: 1.8rem;">
                  <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #333; padding-bottom: 1rem; margin-bottom: 1.2rem;">
                ...
                <div id="material-quantity-container" style="background: #0A0A0A; border: 2px solid #FFF; box-shadow: 4px 4px 0px var(--cmyk-yellow); padding: 1.5rem; position: relative;">
                  <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 1rem; flex-wrap: wrap; gap: 0.5rem;">
                    <span style="color: var(--cmyk-yellow); font-weight: 900;">📊 COST BREAKDOWN ALLOCATION & RAW MATERIAL ESTIMATOR</span>
                  ...
                  <div style="background: #000; border: 1px dashed #333; padding: 1.2rem; margin-bottom: 1.5rem;">
                    ...
                    <div style="width: 100%; height: 26px; display: flex; border: 2px solid #FFF; overflow: hidden; margin-bottom: 0.8rem;">
                      <div id="bar-civil" style="width: 40%; background: #00E5FF; transition: width 0.4s ease;" title="Civil Structure & RCC (40%)"></div>
                      <div id="bar-finish" style="width: 35%; background: #FF007F; transition: width 0.4s ease;" title="Finishing & Joinery (35%)"></div>
                      <div id="bar-mep" style="width: 15%; background: #00FF66; transition: width 0.4s ease;" title="MEP / Plumbing & Electrical (15%)"></div>
                      <div id="bar-labor" style="width: 10%; background: #FFD700; transition: width 0.4s ease;" title="Labor & Supervision (10%)"></div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); gap: 0.8rem; font-family: var(--font-mono); font-size: 0.75rem;">
                      <div>
                        <span style="color: #00E5FF; font-weight: 900;">■ CIVIL & RCC (40%)</span>
                        <div id="cost-val-civil" style="color: #FFF; font-weight: 700;">NPR 46.0 Lakhs</div>
                      </div>
                      <div>
                        <span style="color: #FF007F; font-weight: 900;">■ FINISHING (35%)</span>
                        <div id="cost-val-finish" style="color: #FFF; font-weight: 700;">NPR 40.2 Lakhs</div>
                      </div>
                      <div>
                        <span style="color: #00FF66; font-weight: 900;">■ MEP SERVICES (15%)</span>
                        <div id="cost-val-mep" style="color: #FFF; font-weight: 700;">NPR 17.3 Lakhs</div>
                      </div>
                      <div>
                        <span style="color: #FFD700; font-weight: 900;">■ LABOR (10%)</span>
                  ...
                  <div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1rem;">
                      ...
                      <!-- Cement Bags -->
                      <div style="background: #111; border: 2px solid #FFF; padding: 1rem; position: relative;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                          <span style="font-size: 1.5rem;">🧱</span>
                          <span style="font-family: var(--font-mono); font-size: 0.65rem; color: var(--cmyk-cyan); font-weight: 700;">EST. MATERIAL</span>
                        </div>
                      ...
                      <div style="background: #111; border: 2px solid #FFF; padding: 1rem; position: relative;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                          ...
                          <span style="font-family: var(--font-mono); font-size: 0.65rem; color: var(--cmyk-pink); font-weight: 700;">EST. MATERIAL</span>
                        </div>
                      ...
                      <div style="background: #111; border: 2px solid #FFF; padding: 1rem; position: relative;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                          <span style="font-size: 1.5rem;">🧱</span>
                          <span style="font-family: var(--font-mono); font-size: 0.65rem; color: var(--cmyk-yellow); font-weight: 700;">EST. MATERIAL</span>
                        </div>
                        <div style="font-family: var(--font-mono); font-size: 0.75rem; color: #AAA; font-weight: 700;">RED BRICKS</div>
                      ...
                      <div style="background: #111; border: 2px solid #FFF; padding: 1rem; position: relative;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                          <span style="font-size: 1.5rem;">🚛</span>
                          <span style="font-family: var(--font-mono); font-size: 0.65rem; color: var(--cmyk-green); font-weight: 700;">EST. MATERIAL</span>
                        </div>
