  ...
  return `
    <div id="legal" class="tab-pane active-pane">
      <div class="scope-container">
        ...
        <div class="permit-bylaws-box" style="background: var(--bg-card); border: var(--border-thick); border-radius: var(--radius-card); padding: 1.8rem; margin-bottom: 2.5rem;">
          ...
          <p style="color: var(--text-muted); font-size: 0.95rem; margin-bottom: 1.5rem; max-width: 800px;">
          ...
          <div style="display: flex; gap: 1.5rem; align-items: flex-end; flex-wrap: wrap; margin-bottom: 1.2rem;">
            <div style="flex: 1; min-width: 240px;">
              <label style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--text-muted); font-weight: 700; display: block; margin-bottom: 0.5rem;">
                RIGHT-OF-WAY ROAD WIDTH (METERS):
              </label>
              <input type="number" id="road-width-input" value="4.0" step="0.5" min="2" max="15" style="width: 100%; background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 6px; color: #FFF; font-family: var(--font-mono); font-size: 1.2rem; padding: 0.8rem 1rem; font-weight: 700; box-sizing: border-box;" />
            </div>

            <div id="bylaws-result-badge" style="flex: 2; min-width: 280px; background: var(--bg-surface); border: 1px solid var(--nothing-red); border-radius: 6px; padding: 0.9rem 1.2rem; font-family: var(--font-mono); font-size: 0.85rem;">
              <div style="color: var(--nothing-red); font-weight: 700; margin-bottom: 0.3rem;">MAX ALLOWED HEIGHT:</div>
              <div id="bylaws-result-text" style="color: #FFF; font-weight: 700; font-size: 1.1rem;">
          ...
          <div id="bylaws-svg-container" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 6px; padding: 1.2rem; margin-top: 1.5rem; position: relative;">
            <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem; flex-wrap: wrap; gap: 0.5rem;">
              ...
              <span id="bylaws-status-stamp" style="background: var(--nothing-red); color: #FFF; font-weight: 700; padding: 0.2rem 0.6rem; border-radius: 4px; font-size: 0.7rem;">[KMC BYLAWS COMPLIANT]</span>
            </div>

            <div style="width: 100%; height: 220px; position: relative; background: #000; border: 1px dashed var(--border-color); border-radius: 6px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
              <svg id="bylaws-svg-canvas" viewBox="0 0 500 220" style="width: 100%; height: 100%;">
                ...
                <g id="road-profile-group">
                  ...
                  <line id="svg-road-axis" x1="120" y1="140" x2="120" y2="180" stroke="#FF2800" stroke-width="1.5" stroke-dasharray="4,3" />
                  ...
                  <line x1="60" y1="162" x2="180" y2="162" stroke="#FF2800" stroke-width="1.5" />
                  <line x1="60" y1="157" x2="60" y2="167" stroke="#FF2800" stroke-width="1.5" />
                  <line x1="180" y1="157" x2="180" y2="167" stroke="#FF2800" stroke-width="1.5" />
                </g>
                ...
                <g id="setback-zone-group">
                  <rect x="180" y="50" width="60" height="130" fill="url(#setback-no-build-hatch-n)" fill-opacity="0.35" stroke="#FF2800" stroke-width="1.5" stroke-dasharray="4,3" />
                  <text x="210" y="115" fill="#FF2800" font-family="monospace" font-size="9" font-weight="bold" text-anchor="middle" transform="rotate(-90 210 115)">1.5M SETBACK (NO BUILD)</text>
                </g>

                <line x1="240" y1="30" x2="240" y2="180" stroke="#FFF" stroke-width="2" stroke-dasharray="5,4" />
                <text x="243" y="42" fill="#FFF" font-family="monospace" font-size="9" font-weight="bold">SETBACK LINE</text>

                <g id="bldg-envelope-group">
                  <rect id="svg-bldg-rect" x="240" y="60" width="200" height="120" fill="none" stroke="#FF2800" stroke-width="2.5" />

                  <line x1="240" y1="140" x2="440" y2="140" stroke="#FF2800" stroke-width="1" stroke-dasharray="3,3" />
                  <line x1="240" y1="100" x2="440" y2="100" stroke="#FF2800" stroke-width="1" stroke-dasharray="3,3" />
                  ...
                  <path d="M 240 100 L 220 100 L 220 120 L 240 120" fill="none" stroke="#FF2800" stroke-width="1.5" />
                  <text x="218" y="95" fill="#FF2800" font-family="monospace" font-size="8" font-weight="bold" text-anchor="end">MAX 1.0M BALCONY</text>
                </g>
              </svg>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; font-family: var(--font-mono); font-size: 0.75rem; color: #AAA; margin-top: 0.8rem; border-top: 1px dashed var(--border-color); padding-top: 0.6rem; flex-wrap: wrap; gap: 0.5rem;">
              <div>SETBACK MANDATE: <span style="color: var(--nothing-red); font-weight: 700;">1.5M (5.0 FT) FROM PROPERTY LINE</span></div>
              <div>GROUND COVERAGE: <span style="color: #FFF; font-weight: 700;">70% MAX GROUND RATIO</span></div>
        ...
        <div class="naksha-pipeline-container" style="background: var(--bg-card); border: var(--border-thick); border-radius: var(--radius-card); padding: 2rem; margin-bottom: 2.5rem;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.8rem; flex-wrap: wrap; gap: 1rem; border-bottom: 1px dashed var(--border-color); padding-bottom: 1.2rem;">
            ...
            <div style="text-align: right;">
              <div style="font-family: var(--font-mono); font-size: 0.85rem; color: var(--text-muted); font-weight: 700; margin-bottom: 0.4rem;">
                TAP CARDS TO STAMP & APPROVE
              </div>
              <div id="naksha-progress-meter" style="background: var(--bg-surface); border: 1px solid var(--nothing-red); color: var(--nothing-red); font-family: var(--font-mono); font-weight: 700; padding: 0.4rem 0.8rem; border-radius: 4px; font-size: 0.85rem;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.5rem; position: relative;">
            ...
            <!-- STAGE 01 -->
            <div class="pipeline-stage-card active-stage" data-stage="1" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-card); padding: 1.2rem; cursor: pointer; transition: transform 0.2s ease, border-color 0.2s ease;">
              <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem;">
                <span style="background: var(--nothing-red); color: #FFF; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 4px;">STAGE 01</span>
                <span style="color: #AAA;">KAGAZ-PATRA</span>
              </div>
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.8rem;">Document Dossier & CAD Blueprint</h4>

              <div style="width: 100%; height: 140px; background: #000; border: 1px dashed var(--border-color); border-radius: 4px; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                <svg viewBox="0 0 200 140" style="width: 100%; height: 100%;">
                  <rect x="20" y="20" width="160" height="100" fill="#0A0A0F" stroke="#FFF" stroke-width="1.5" />
                  ...
                  <rect x="30" y="72" width="100" height="38" fill="none" stroke="#FF2800" stroke-width="1" stroke-dasharray="2,2" />
                  <text x="80" y="93" fill="#FF2800" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">NEC CAD BLUEPRINT</text>

                  <g id="stamp-stage-1" transform="translate(40, 50) rotate(-10)" opacity="1">
                    <rect x="0" y="0" width="120" height="26" fill="none" stroke="#FF2800" stroke-width="2" rx="3" />
                    <text x="60" y="17" fill="#FF2800" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">LALPURJA VERIFIED</text>
                  </g>
                </svg>
              </div>
            ...
            <!-- STAGE 02 -->
            <div class="pipeline-stage-card" data-stage="2" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-card); padding: 1.2rem; cursor: pointer; transition: transform 0.2s ease, border-color 0.2s ease;">
              <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem;">
                <span style="background: var(--nothing-red); color: #FFF; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 4px;">STAGE 02</span>
                <span style="color: #AAA;">PLINTH LEVEL</span>
              </div>
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.8rem;">Asthai Ijajat & Plinth Inspection</h4>

              <div style="width: 100%; height: 140px; background: #000; border: 1px dashed var(--border-color); border-radius: 4px; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                <svg viewBox="0 0 200 140" style="width: 100%; height: 100%;">
                  <rect x="20" y="90" width="160" height="25" fill="#222" stroke="#FF2800" stroke-width="1.5" />
                  <text x="100" y="106" fill="#FF2800" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">PLINTH BEAM CASTING +2'0"</text>
                  <rect x="40" y="25" width="120" height="50" fill="#111" stroke="#FFF" stroke-width="1.5" />
                  <text x="100" y="48" fill="#FFF" font-family="monospace" font-size="9" font-weight="bold" text-anchor="middle">15-DINE SUCHANA</text>
                  ...
                  <g id="stamp-stage-2" transform="translate(35, 45) rotate(-8)" opacity="0">
                    <rect x="0" y="0" width="130" height="26" fill="none" stroke="#FF2800" stroke-width="2" rx="3" />
                    <text x="65" y="17" fill="#FF2800" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">ASTHAI PERMIT PASSED</text>
                  </g>
                </svg>
              </div>
            ...
            <!-- STAGE 03 -->
            <div class="pipeline-stage-card" data-stage="3" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-card); padding: 1.2rem; cursor: pointer; transition: transform 0.2s ease, border-color 0.2s ease;">
              <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem;">
                <span style="background: var(--nothing-red); color: #FFF; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 4px;">STAGE 03</span>
                <span style="color: #AAA;">SUPERSTRUCTURE</span>
              </div>
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.8rem;">Sthai Ijajat (Superstructure Approval)</h4>

              <div style="width: 100%; height: 140px; background: #000; border: 1px dashed var(--border-color); border-radius: 4px; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                <svg viewBox="0 0 200 140" style="width: 100%; height: 100%;">
                  <rect x="40" y="30" width="120" height="90" fill="none" stroke="#FFF" stroke-width="2" />
                  <line x1="40" y1="75" x2="160" y2="75" stroke="#FFF" stroke-width="2" />
                  <rect x="45" y="30" width="10" height="90" fill="#FF2800" />
                  <rect x="95" y="30" width="10" height="90" fill="#FF2800" />
                  <rect x="145" y="30" width="10" height="90" fill="#FF2800" />
                  <text x="100" y="112" fill="#FFF" font-family="monospace" font-size="7" font-weight="bold" text-anchor="middle">KMC SETBACK & HEIGHT OK</text>

                  <g id="stamp-stage-3" transform="translate(40, 50) rotate(-6)" opacity="0">
                    <rect x="0" y="0" width="120" height="26" fill="none" stroke="#FFF" stroke-width="2" rx="3" />
                    <text x="60" y="17" fill="#FFF" font-family="monospace" font-size="8" font-weight="bold" text-anchor="middle">STHAI APPROVED</text>
                  </g>
                </svg>
              </div>
            ...
            <!-- STAGE 04 -->
            <div class="pipeline-stage-card" data-stage="4" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: var(--radius-card); padding: 1.2rem; cursor: pointer; transition: transform 0.2s ease, border-color 0.2s ease;">
              <div style="display: flex; justify-content: space-between; align-items: center; font-family: var(--font-mono); font-size: 0.75rem; margin-bottom: 0.8rem;">
                <span style="background: var(--nothing-red); color: #FFF; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 4px;">STAGE 04</span>
                <span style="color: #AAA;">COMPLETION</span>
              </div>
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.8rem;">Nirman Sampanna (Completion)</h4>

              <div style="width: 100%; height: 140px; background: #000; border: 1px dashed var(--border-color); border-radius: 4px; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
                <svg viewBox="0 0 200 140" style="width: 100%; height: 100%;">
                  <polygon points="100,20 30,60 170,60" fill="none" stroke="#FF2800" stroke-width="2" />
                  <rect x="40" y="60" width="120" height="60" fill="none" stroke="#FF2800" stroke-width="2" />
                  ...
                  <g id="stamp-stage-4" transform="translate(20, 50) rotate(-10)" opacity="0">
                    <rect x="0" y="0" width="160" height="28" fill="none" stroke="#FF2800" stroke-width="2.5" rx="3" />
                    <text x="80" y="18" fill="#FF2800" font-family="monospace" font-size="7.5" font-weight="bold" text-anchor="middle">NIRMAN SAMPANNA CERTIFICATE</text>
                  </g>
                </svg>
              </div>
        ...
        <div style="background: var(--bg-card); border: var(--border-thick); border-radius: var(--radius-card); padding: 2rem;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 1rem;">
            <div>
              <span class="badge brutal-badge pink" style="background: var(--nothing-red); color: #FFF;">DOCUMENTATION</span>
              <h3 style="font-family: var(--font-mono); font-size: 1.4rem; font-weight: 700; color: #FFF; margin-top: 0.4rem; text-transform: uppercase; letter-spacing: 1px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.2rem;">
            ...
            <div class="doc-item-card" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 6px; padding: 1.2rem; position: relative;">
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.6rem;">
                <span style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--nothing-red); font-weight: 700;">DOC #01</span>
                
                <div class="doc-sample-trigger" style="position: relative; display: inline-block;">
                  <span class="badge brutal-badge yellow" style="font-size: 0.65rem; padding: 0.1rem 0.4rem; cursor: pointer; background: var(--nothing-red); color: #FFF;">🔍 DOC SAMPLE</span>
                  <div class="doc-sample-popover" style="display: none; position: absolute; right: 0; top: 120%; width: 180px; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 6px; z-index: 100; padding: 0.5rem;">
                    <img src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=300&q=80" alt="Lalpurja Land Ownership Certificate" style="width: 100%; height: 100px; object-fit: cover; border-radius: 4px;">
              ...
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.4rem;">Land Ownership Certificate (Lalpurja)</h4>
              <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.4;">Official government land title deed registered under Malpot Karyalaya.</p>
            </div>

            <div class="doc-item-card" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 6px; padding: 1.2rem; position: relative;">
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.6rem;">
                <span style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--nothing-red); font-weight: 700;">DOC #02</span>
                
                <div class="doc-sample-trigger" style="position: relative; display: inline-block;">
                  <span class="badge brutal-badge pink" style="font-size: 0.65rem; padding: 0.1rem 0.4rem; cursor: pointer; color: #FFF; background: var(--nothing-red);">🔍 DOC SAMPLE</span>
                  <div class="doc-sample-popover" style="display: none; position: absolute; right: 0; top: 120%; width: 180px; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 6px; z-index: 100; padding: 0.5rem;">
                    <img src="https://images.unsplash.com/photo-1524813686514-a57563d77965?auto=format&fit=crop&w=300&q=80" alt="Cadastral Map Trace" style="width: 100%; height: 100px; object-fit: cover; border-radius: 4px;">
              ...
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.4rem;">Cadastral Trace Map (Char-Killa)</h4>
              <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.4;">Official Survey Department plot map showing adjacent land boundaries.</p>
            </div>

            <div class="doc-item-card" style="background: var(--bg-surface); border: 1px solid var(--border-color); border-radius: 6px; padding: 1.2rem; position: relative;">
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.6rem;">
                <span style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--nothing-red); font-weight: 700;">DOC #03</span>
                
                <div class="doc-sample-trigger" style="position: relative; display: inline-block;">
                  <span class="badge brutal-badge cyan" style="font-size: 0.65rem; padding: 0.1rem 0.4rem; cursor: pointer; color: #FFF; background: var(--nothing-red);">🔍 DOC SAMPLE</span>
                  <div class="doc-sample-popover" style="display: none; position: absolute; right: 0; top: 120%; width: 180px; background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 6px; z-index: 100; padding: 0.5rem;">
                    <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=300&q=80" alt="NEA Engineering Blueprints" style="width: 100%; height: 100px; object-fit: cover; border-radius: 4px;">
              ...
              <h4 style="font-weight: 700; font-size: 1.1rem; color: #FFF; margin-bottom: 0.4rem;">Architectural & Structural Drawings</h4>
              <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.4;">Signed NBC 105:2020 structural analysis and 3D architectural elevations.</p>
            </div>
  ...
  function updateBylawsGraphic(roadWidth) {
    ...
    if (widthM < 3.0) {
      if (statusStamp) {
        ...
        statusStamp.style.background = '#FF9900';
